        ...
        <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20 gap-4 lg:gap-6">
                ...
                <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex-shrink-0 flex items-center cursor-pointer group">
                    <img src="/logo.png" alt="Tsehay Campus Logo" className="h-14 w-auto object-contain mr-2 lg:mr-3 rounded-md shadow-sm group-hover:shadow-md transition duration-300" onError={(e) => { e.currentTarget.src='https://ui-avatars.com/api/?name=TC&background=3268BA&color=fff' }} />
