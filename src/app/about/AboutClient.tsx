...
import { parseVideoEmbedUrl, parseImageUrl, getMediaThumbnail, isMediaVideo, CommunityMediaItem } from '@/lib/videoParser';
        ...
        <section id="about" className="pt-28 sm:pt-36 pb-24 relative z-10 flex-1">
          <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 space-y-20 sm:space-y-28">
            ...
            <div className="space-y-8 pt-8 border-t border-white/5">
              ...
              {/* Dynamic Responsive Community Gallery */}
              <CommunityMediaGallery 
                initialCommunityMedia={initialCommunityMedia} 
                initialCommunityMediaUrl={initialCommunityMediaUrl} 
              />
            </div>
...
// =========================================================================
// 🌟 2. ZERO-LATENCY SHORT REELS PLAYER
// =========================================================================
interface ShortReel {
  id: string;
  src: string;
