...
const translations: Record<string, Record<Language, string>> = {
  ...
  'faq_a1': { am: 'ይህንን ስልጠና ለመከታተል ምንም አይነት የቅድሚያ እውቀት ወይም ልዩ መሳሪያ አያስፈልግም። ኢንተርኔት የሚያገኝ ስማርት ስልክ (Smartphone) ወይም ላፕቶፕ፣ እንዲሁም ለመማር እና ተግባራዊ ለማድረግ የቆረጠ አእምሮ ብቻ በቂ ነው። ትምህርቶቹ ከጀማሪ እስከ ባለሙያ ደረጃ (From zero to hero) በቀላል አማርኛ ደረጃ በደረጃ የተዘጋጁ ናቸው።', en: 'You do not need any prior knowledge or special equipment to take this training. A smartphone with internet access or a laptop, along with a determined mind to learn and apply, is enough. The lessons are prepared step-by-step in simple Amharic from zero to hero.' },
  'faq_q2': { am: 'የ AI ረዳቱን ለመጠቀም ተጨማሪ ክፍያ አለው?', en: 'Is there an additional fee to use the AI assistant?' },
  'faq_a2': { am: 'በፍጹም! የ "Tsehay AI" ረዳት በካምፓሳችን ውስጥ ለሚገኙ ሁሉም ኮርሶች በነፃ የተካተተ ነው። አንዴ ኮርሱን ከጀመሩ በኋላ 24/7 ከጎንዎ ሆኖ ጥያቄዎችዎን ይመልሳል፣ የቢዝነስ ሀሳቦችን ያመነጭልዎታል፣ እንዲሁም ማስታወቂያዎችን እንዲጽፉ ያግዝዎታል። ለዚህ ምንም አይነት ተጨማሪ ወርሃዊም ሆነ አመታዊ ክፍያ አንጠይቅም።', en: 'Absolutely not! The "Tsehay AI" assistant is included for free in all courses on our campus. Once you start the course, it will be by your side 24/7 to answer your questions, generate business ideas, and help you write ads. We do not ask for any additional monthly or annual fee for this.' },
  'faq_q3': { am: 'ትምህርቱን ስጨርስ ሰርተፍኬት አገኛለሁ?', en: 'Will I get a certificate when I finish the course?' },
  'faq_a3': { am: 'አዎ፣ በእርግጥ! እያንዳንዱን ኮርስ (ቪዲዮዎቹን እና አጭር ፈተናዎችን) ሙሉ በሙሉ አጠናቀው እንደጨረሱ በስምዎ የተዘጋጀ ዲጂታል ሰርተፍኬት (Certificate of Completion) ወዲያውኑ ይደርስዎታል። ይህንን ሰርተፍኬት አውርደው ለስራ ማመልከቻ፣ ለሲቪ (CV) ማሳመሪያ ወይም በሊንክድኢን (LinkedIn) ላይ ለማጋራት መጠቀም ይችላሉ።', en: 'Yes, absolutely! Once you have completely finished each course (the videos and short quizzes), a digital certificate (Certificate of Completion) prepared in your name will be delivered to you immediately. You can download this certificate and use it for job applications, enhancing your CV, or sharing it on LinkedIn.' },
